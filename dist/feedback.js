...
var parseSerialize=require("./helpers").parseSerialize;function sendMessage(e){var a=$.Deferred(),r={lang:parseSerialize(window.location.search).lang||"",feedback:e};return"google"===Shop.config.config.captcha_type&&(r["g-recaptcha-response"]=e["g-recaptcha-response"]),$.post("/client_account/feedback.json",$.param(r)).done(function(e){r&&"ok"===e.status?a.resolve(e):(e.message=r,a.reject(e))}),a.promise()}module.exports=sendMessage;
