...
var parseSerialize=require("./helpers").parseSerialize;function sendMessage(e){var a=$.Deferred(),o={lang:parseSerialize(window.location.search).lang||"",feedback:e};return Shop&&Shop.config&&Shop.config.config&&"google"===Shop.config.config.captcha_type&&(o["g-recaptcha-response"]=e["g-recaptcha-response"]),$.post("/client_account/feedback.json",$.param(o)).done(function(e){o&&"ok"===e.status?a.resolve(e):(e.message=o,a.reject(e))}),a.promise()}module.exports=sendMessage;
